...
function _distancePstoPs(__model__: Sim, from_posi_i: number, to_posis_i: number[],
...
// function _distancePstoW(__model__: Sim, from_posi_i: number, to_wires_i: number[]): number {
//     const from_xyz: Txyz = __model__.modeldata.attribs.posis.getPosiCoords(from_posi_i);
//     let min_dist = Infinity;
//     const map_posi_xyz: Map<number, Txyz> = new Map();
//     for (const wire_i of to_wires_i) {
//         // get the posis
//         const to_posis_i: number[] = __model__.modeldata.geom.nav.navAnyToPosi(ENT_TYPE.WIRE, wire_i);
...
//     return min_dist;
// }
function _distancePstoE(__model__: Sim, from_posi_i: number, to_edges_i: number[],
        map_posi_i_xyz: Map<number, Txyz>): number {
    const from_xyz: Txyz = __model__.modeldata.attribs.posis.getPosiCoords(from_posi_i);
    let min_dist = Infinity;
