 ...
 */
 export function VrPanorama(
    ...
    let phs_dict = __model__.modeldata.attribs.get.getEntAttribVal(ENT_TYPE.POINT, ent_i, "vr_hotspot");
    ...
    __model__.modeldata.attribs.set.setEntAttribVal(ENT_TYPE.POINT, ent_i, "vr_hotspot", phs_dict);
}
