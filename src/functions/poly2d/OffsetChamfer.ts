...
/**
 * Offset a polyline or polygon, with chamfered/squared joints. The original entities are unmodified.
 * \n
 ...
 */
export function OffsetChamfer(__model__: Sim, entities: string | string[], dist: number,
    end_type: _EOffset): string[] {
