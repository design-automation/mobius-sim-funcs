...
const check_v1 = sf.query.Get(qEnum._EEntType.VERT, null);
const check_ps1 = sf.query.Get(qEnum._EEntType.POSI, null);
//Initial weld
const weld1 = sf.edit.Weld([check_v1[0], check_v1[4]], Enum._EWeldMethod.MAKE_WELD)

const check_v2 = sf.query.Get(qEnum._EEntType.VERT, null);
const check_ps2 = sf.query.Get(qEnum._EEntType.POSI, null);
//Breaking weld 
const weld3 = sf.edit.Weld(check_v2, Enum._EWeldMethod.BREAK_WELD)

const check_v3 = sf.query.Get(qEnum._EEntType.VERT, null);
const check_ps3 = sf.query.Get(qEnum._EEntType.POSI, null);
