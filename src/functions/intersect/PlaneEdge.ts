 ...
 * @param plane_tjs
 */
function _intersectPlane(__model__: Sim, ents_arr: string|string[], plane_tjs: THREE.Plane): Txyz[] {
    if (getArrDepth(ents_arr) === 1) {
        ...
        for (const ent_arr of ents_arr) {
            const isect_xyzs: Txyz[] = _intersectPlane(__model__, ent_arr as string, plane_tjs);
 ...
 * @param plane_tjs
 */
function _intersectPlaneWire(__model__: Sim, wire_i: number, plane_tjs: THREE.Plane): Txyz[] {
    const isect_xyzs: Txyz[] = [];
    const wire_posis_i: number[] = __model__.modeldata.geom.nav.navAnyToPosi(ENT_TYPE.WIRE, wire_i);
 ...
 * @param plane_tjs
 */
function _intersectPlaneEdge(__model__: Sim, edge_i: number, plane_tjs: THREE.Plane): Txyz[] {
