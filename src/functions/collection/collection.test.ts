...
const check1 = sf.query.Get(qEnum._ENT_TYPE.COLL, null)
const col1 = sf.collection.Create(null, "Collect1")
const check2 = sf.query.Get(qEnum._ENT_TYPE.COLL, null)
...
test('Check col deletion', () => {
    ...
    const check_del = sf.query.Get(qEnum._ENT_TYPE.COLL, null)
    //@ts-ignore
