...
sf.attrib.Add(Enum._EEntTypeAndMod.POSI, Enum._EDataType.STRING, 'TestAttr')
...
sf.attrib.Rename(Enum._EEntTypeAndMod.POSI, 'TestAttr', 'NewAttr')
const attr_check2 = sf.attrib.Discover(Enum._EEntTypeAndMod.POSI)
...
const value_check = sf.attrib.Values(Enum._EEntTypeAndMod.POSI, 'NewAttr')
...
sf.attrib.Delete(Enum._EEntTypeAndMod.POSI, 'NewAttr')
const attr_check3 = sf.attrib.Discover(Enum._EEntTypeAndMod.POSI)
...
const attr_check4 = sf.attrib.Discover(Enum._EEntTypeAndMod.PGON)
