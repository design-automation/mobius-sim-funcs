 ...
 */
export function Box(__model__: Sim, origin: Txyz | TPlane,
    ...
    if (method === _EBoxMethod.FLAT) {
        ...
        return idsMakeFromIdxs(ENT_TYPE.POSI, all_posis) as string[];
        ...
        return idsMakeFromIdxs(ENT_TYPE.POSI, posis_i2) as string[][];
