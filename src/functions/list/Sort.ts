import { getArrDepth, idsBreak, string } from '../../mobius_sim';
 ...
 * @param method Enum, specifies the sort method to use: `'reverse', 'alpha_descending',
 ...
 * @example_info where `list = ["1","2","10","Orange","apple"]`. Expected value of list is
 * `["1","10","2","Orange","apple"]`.
