import { ENT_TYPE, getArrDepth, Sim, idsBreak, string, string, TRay, Txyz } from '../../mobius_sim';
...
function _intersectRay(__model__: Sim, ents_arr: string|string[], ray_tjs: THREE.Ray): Txyz[] {
    if (getArrDepth(ents_arr) === 1) {
        ...
        for (const ent_arr of ents_arr) {
            const isect_xyzs: Txyz[] = _intersectRay(__model__, ent_arr as string, ray_tjs);
