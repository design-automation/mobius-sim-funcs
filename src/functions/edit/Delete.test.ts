...
const check1 = sf.query.Get(qEnum._ENT_TYPE.POSI, null)
sf.edit.Delete(posis[1], Enum._EDeleteMethod.DELETE_SELECTED)
const check2 = sf.query.Get(qEnum._ENT_TYPE.POSI, null)
...
const check3 = sf.query.Get(qEnum._ENT_TYPE.POSI, null)
